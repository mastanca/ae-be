...
import (
	...
	"github.com/mastanca/go-api-template/cmd/web/middleware"
...
func (l *loginHandlerImpl) Handle(c *gin.Context) {
	...
	// TODO: We should send expire time and build regen token endpoint to avoid asking
	// for pass and username again each 5 mins, but lets keep it this way for this template
